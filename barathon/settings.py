...
SECRET_KEY = 'django-insecure-rn2#erhuukex+rzi&-#fcmjx-fi%zu_)f&@z(wqysm+ig7g21l'
...
WSGI_APPLICATION = 'barathon.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            ...
            'trusted_connection': 'yes',  # Necesario para autenticación de Windows
        },
    }
}
